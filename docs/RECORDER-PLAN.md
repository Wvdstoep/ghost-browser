...
|---|---|---|---|
| 0 | Foundations: sound, a display per recording, a volume of its own | planned | a 60 s recording of a public video has picture AND sound; the pool's sessions and watchers notice nothing |
