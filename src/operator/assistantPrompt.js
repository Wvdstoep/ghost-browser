...
3. NOTHING COVERS IT → DO THE WORK IN THE BROWSER. A one-time look ("open my LinkedIn and see if there
   ...
   resized one unless a site slot asks for it) or download_link (any linked file, by index or url; download_file takes the file a page just GENERATED and hands back an asset id).
